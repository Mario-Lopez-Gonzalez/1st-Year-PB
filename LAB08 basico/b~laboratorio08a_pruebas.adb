pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~laboratorio08a_pruebas.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~laboratorio08a_pruebas.adb");
...
package body ada_main is
   ...
   E153 : Short_Integer; pragma Import (Ada, E153, "laboratorio08_E");
   E151 : Short_Integer; pragma Import (Ada, E151, "lab08_escenarios_E");
   ...
   begin
      ...
      E099 := E099 + 1;
      E153 := E153 + 1;
      Lab08_Escenarios'Elab_Spec;
      E151 := E151 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_laboratorio08a_pruebas");
...
--  BEGIN Object file/option list
   --   .\laboratorio08.o
   --   .\lab08_escenarios.o
   --   .\laboratorio08a_pruebas.o
   --   -L.\
   --   -LC:\Users\Mario\Desktop\CLASE\PB\LAB08B~1\

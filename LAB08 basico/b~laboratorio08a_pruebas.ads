...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_laboratorio08a_pruebas" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f5aca037#;
   pragma Export (C, u00001, "laboratorio08a_pruebasB");
   ...
   u00151 : constant Version_32 := 16#6dac22fc#;
   pragma Export (C, u00151, "lab08_escenariosS");
   u00152 : constant Version_32 := 16#5b5a4921#;
   pragma Export (C, u00152, "laboratorio08B");
   u00153 : constant Version_32 := 16#5afca441#;
   pragma Export (C, u00153, "laboratorio08S");
